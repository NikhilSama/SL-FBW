			...
			<div class="ingredientsForm ingredients row-fluid">
				<form class="form" id="IngredientChangeForm" method="post">
							...
							<div class="upload_image_box app_icon">
			                    <div class="text">
			                        ...
			                        <div class="app-icon-show">
			                    		<img src="<?php if($ingredient_data['app_icon']) {echo $ingredient_data['app_icon']; } else {echo 'img/dummy_image.png'; } ?>" data-value="<?php if($ingredient_data['app_icon']){echo 1;} else {echo 0;} ?>" style="width:102px;" class="iconImage">
			                    	</div>
			                    </div>
			                </div>
			                <div class="row field">
								...
								<div class="upload_image_box splash_screen splashscreen-size mb-0">
				                    ...
				                    <div class="preview" id="splash_preview">
				                        <div class="dummy_image_wrapper">
				                            <img src="<?php if($ingredient_data['appSplashImage']){ echo $ingredient_data['appSplashImage']; } else { echo 'img/dummy_image.png'; } ?>" style='<?php if($ingredient_data['appSplashImage']){ echo "width: 100%; width:216px; height:383px;margin-top: 0px;margin-left: 0px;top: 0px; left:0px;"; } else { echo "position: absolute;top: 50%;left: 50%;margin: -50px -60px;"; } ?>' data-value="<?php if($ingredient_data['appSplashImage']){echo '1';} else {echo '0';} ?>" alt="" class="dummyImage">
				                        </div>
				                    </div>
			                	</div>
					...
					<div class="span12 text-center mb-10">
						<a href="imported.php" class="btn btn-large btn-warning">Cancel</a>
